const projects: Project[] = [
    {
      ...
      imgUrl: '/files/solidguard.png',
      zipUrl: '/files/solidguard.zip',
    ...
    },
    {
      ...
      imgUrl: '/files/stock-predictions.png',
      zipUrl: '/files/stock-predictions.zip',
    ...
    },
    {
      ...
      imgUrl: '/files/grr-pi.jpg',
      zipUrl: '/files/grr-pi.zip',
      githubUrl: 'https://github.com/jangarong/StockMarketPredictions'
    },
    {
      name: 'Mummy Run',
      description: 'A history-themed flash game featuring MCQs and bullethell!',
      imgUrl: '/files/mummy-run.png',
      zipUrl: '/files/mummy-run.zip',
    },
  ];
